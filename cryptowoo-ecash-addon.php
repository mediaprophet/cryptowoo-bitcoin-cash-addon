...
function cwxec_add_fields_v4() {
    ...
    */
	...
	Redux::set_field( 'cryptowoo_payments', 'rates-exchange', array(
		...
		'subtitle'          => sprintf( __( 'Choose the exchange you prefer to use to calculate the %seCash to eexchange rate%s', 'cryptowoo' ), '<strong>', '</strong>.' ),
	...
	Redux::set_field( 'cryptowoo_payments', 'wallets-hdwallet', array(
		...
		'ajax_save'         => false,
		'username'          => false,
		'desc'              => __( 'eTESTNET extended public key (tpub...)', 'cryptowoo-hd-wallet-addon' ),
		'title'             => __( 'eTESTNET HD Wallet Extended Public Key', 'cryptowoo-hd-wallet-addon' ),
		'validate_callback' => 'redux_validate_mpk',
		'placeholder'       => 'tpub...',
		'text_hint'         => array(
			'title'   => 'Please Note:',
